...
def plot_statistics(file_to_metrics):
    ...
    save_file = "outputs/medmcqa/figures/entropy.png"
    plt.tight_layout()
...
if __name__ == "__main__":
    ...
    retained_ids_list += [retained_ids] * 2
    retained_ids = get_retained_keys([
        "outputs/medmcqa/processed_results/NVIDIA-Nemotron-Nano-9B-v2_temp0.6_n50_dt_counts.jsonl",
        "outputs/medmcqa/processed_results/NVIDIA-Nemotron-Nano-9B-v2_temp0.6_n50_counts.jsonl",
    ])
    retained_ids_list += [retained_ids] * 2
    retained_ids = get_retained_keys([
        "outputs/medmcqa/processed_results/NVIDIA-Nemotron-Nano-12B-v2_temp0.6_n50_dt_counts.jsonl",
        "outputs/medmcqa/processed_results/NVIDIA-Nemotron-Nano-12B-v2_temp0.6_n50_counts.jsonl",
    ])
    retained_ids_list += [retained_ids] * 2
