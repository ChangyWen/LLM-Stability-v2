...
def load_dataset(file, tokenizer):
    save_dir = "/mnt/blob_output/v-dachengwen/LLM-Stability-v2/outputs/daily_dilemmas/processed_results"
    if not os.path.exists(save_dir):
        os.makedirs(save_dir)
    file = os.path.join("/mnt/blob_output/v-dachengwen/LLM-Stability-v2/outputs/daily_dilemmas", file)
...
if __name__ == "__main__":
    ...
    all_files = os.listdir("/mnt/blob_output/v-dachengwen/LLM-Stability-v2/outputs/daily_dilemmas")
